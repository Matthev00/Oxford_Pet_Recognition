...
def main():
    ...
    train_dataloader_effnetb2, test_dataloader_effnetb2, class_names = create_dataloaders( # noqa 5501
    ...
    train_dataloader_effnetb0, test_dataloader_effnetb0, class_names = create_dataloaders( # noqa 5501
        train_dir=train_path,
        test_dir=test_path,
    ...
    train_dataloader_resnet50, test_dataloader_resnet50, class_names = create_dataloaders( # noqa 5501
        train_dir=train_path,
        test_dir=test_path,
    ...
    for epoch in epochs:
        for model_name in models:
            ...
            if model_name == "effnetb2":
                model, _ = create_effnetb2(num_of_classes=num_classes,
                                           device=device)
                train_dataloader = train_dataloader_effnetb2
                test_dataloader = test_dataloader_effnetb2
            elif model_name == "effnetb0":
                model, _ = create_effnetb0(out_features=num_classes,
                                           device=device)
                train_dataloader = train_dataloader_effnetb0
                test_dataloader = test_dataloader_effnetb0
            else:
                model, _ = create_resnet50(num_of_classes=num_classes,
                                           device=device)
            ...
            engine.train(model=model,
                         ...
                         writer=utils.create_writer(
                             experiment_name=f'{epoch} Epochs',
